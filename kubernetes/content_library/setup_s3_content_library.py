...
class s3_content_library(object):
    ...
    def make_item(self, directory, vcsp_type, name, files, description="", properties={},
            identifier=uuid.uuid4(), creation=datetime.datetime.now(), version=2, library_id=""):
        '''
        ...
        type_metadata_value = "{\"id\":\"%s\",\"version\":\"%s\",\"libraryIdParent\":\"%s\",\"isVappTemplate\":\"%s\",\"vmTemplate\":null,\"vappTemplate\":null,\"networks\":[],\"storagePolicyGroups\":null}" % (item_id, str(version), library_id, "false")
        type_metadata = {
                    "key": "type-metadata",
