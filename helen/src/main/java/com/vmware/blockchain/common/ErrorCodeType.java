...
public final class ErrorCodeType {
    ...
    public static final ErrorCodeType CONCORD_INVALID_RESPONSE =
            new ErrorCodeType("helen.concord.sent.invalid.response", 0);
    ...
    public static final ErrorCodeType CONTRACT_NOT_OWNER =
            new ErrorCodeType("helen.only.original.owner.can.deploy.the.new.version.of.contract", 0);
    public static final ErrorCodeType CONTRACT_VERSION_NOT_FOUND =
            new ErrorCodeType("helen.contract.version.not.found", 2);
    public static final ErrorCodeType CSP_INVALID_JWT_KEY_ID = new ErrorCodeType("helen.invalid.key.ID", 0);
    public static final ErrorCodeType DATABASE_UNAVAILABLE =
            new ErrorCodeType("helen.database.service.is.not.available", 0);
    public static final ErrorCodeType DELETE_INTEGRITY_ERROR =
            new ErrorCodeType("helen.cannot.delete.entity.with.id.and.column.name.", 2);
    public static final ErrorCodeType DUPLICATE_CONTRACT_ID =
            new ErrorCodeType("helen.contract.version.with.id.and.version.already.exists", 2);
    ...
    public static final ErrorCodeType ELEMENTS_SPECIFIED_LESS =
    ...
    public static final ErrorCodeType INVALID_BLOCK_NUMBER = new ErrorCodeType("helen.invalid.block.number", 0);
    ...
    public static final ErrorCodeType INVALID_INPUT_SIZE =
            new ErrorCodeType("helen.input.is.too.large.to.put.in.byte.array.of.size", 0);
    ...
    public static final ErrorCodeType INVALID_RAW_TRANSACTION = new ErrorCodeType("helen.invalid.raw.transaction", 0);
    ...
    public static final ErrorCodeType JSON_METHOD_UNSUPPORTED =
    ...
    public static final ErrorCodeType UNSUITABLE_PARAMETER_NUMBERS =
            new ErrorCodeType("helen.too.many.parameters.either.none.or.a.JSON.object", 0);
    ...
    /**
     * This field contains the number of param that is required in the given ErrorCodeType to form a proper message. It
     * will be used in future to enforce compile-time check that correct set of arguments are passed for a given error
     * code.
     */
