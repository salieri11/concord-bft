...
public final class ErrorCode {
    ...
    public static final String CONCURRENT_UPDATE_FAILED= "Concurrent update on {0}, column name {1}. Try operation again";
    ...
    public static final String DELETE_INTEGRITY_ERROR ="Cannot delete entity with id {0} and column name {1}. It is referenced by other entities.";
    ...
    public static final String INVALID_BLOCK_NUMBER="Invalid block number requested. Block number can either be 'latest', 'pending', 'earliest'or a hex number starting with '0x'";
    public static final String INVALID_BLOCK_REQUEST="Invalid request: Choose correct block numbers, range or a block hash";
    ...
    public static final String INVALID_VERSION_PARAM_VAL = "start/end & max parameters to query versions of the Entity must be between 1 and {0}.";
