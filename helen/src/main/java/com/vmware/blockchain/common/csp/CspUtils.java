...
public class CspUtils {
    /**
     * Get the self ID for the {@code selfLink}. For example, if {@code selfLink} is equal to {@code /core/foo/123},
     * then this method will return {@code 123}.
     *
     * @param selfLink path
     * @return The self ID.
     */
    public static String getSelfId(String selfLink) {
        return selfLink.substring(selfLink.lastIndexOf(Constants.URI_PATH_CHAR) + 1);
    }
