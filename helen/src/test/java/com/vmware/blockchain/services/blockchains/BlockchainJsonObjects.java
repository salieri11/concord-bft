...
public class BlockchainJsonObjects {
    ...
    static final String CORRECT_READ_REPLICA_DETAILS = "{"
                                               + "    \"consortium_id\": \"04e4f62d-5364-4363-a582-b397075b65a3\","
                                               + "    \"blockchain_type\": \"DAML\","
                                               + "    \"replica_zone_ids\": ["
                                               + "            \"84b9a0ed-c162-446a-b8c0-2e45755f3844\","
                                               ...
                                               + "            \"object_store_bucket_name\": \"Bucket Name\","
                                               + "            \"object_store_protocol\": \"Protocol abc\","
                                               + "            \"object_store_secret_key\": \"I am secret\","
                                               + "            \"object_store_url\": \"www.abcd.com\""
                                               + "      }]"
                                               + "}";

    static final String INCORRECT_READ_REPLICA_DETAILS = "{"
            + "    \"consortium_id\": \"04e4f62d-5364-4363-a582-b397075b65a3\","
            + "    \"blockchain_type\": \"DAML\","
            + "    \"replica_zone_ids\": ["
            + "            \"84b9a0ed-c162-446a-b8c0-2e45755f3844\","
