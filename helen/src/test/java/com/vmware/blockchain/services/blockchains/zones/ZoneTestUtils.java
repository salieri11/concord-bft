...
public class ZoneTestUtils {
    private static final String certDataForNotary = "-----BEGIN CERTIFICATE-----\n"
    ...
    public static OnPremZone getOnpremZone(UUID id, UUID orgId) {
        ...
        ozone.setNotaryServer(new OnPremZone.NotaryServer("https://notary.test.com", ZoneTestUtils.certDataForNotary));
