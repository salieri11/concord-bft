...
public class ZoneJsonObjects {
    ...
    static final String POST_ONPREM_BODY_NULL_NAMESERVER = "{\n"
                                                + "  \"name\": \"OnPrem\",\n"
                                                + "  \"type\": \"ON_PREM\",\n"
                                                + "  \"org_id\": \"5e5ff1c8-34b9-4fa3-9924-83eb14354d4c\",\n"
                                                + "  \"vcenter\": {\n"
    ...
    static final String POST_ONPREM_BODY_NO_NAMESERVER = "{\n"
                                                + "  \"name\": \"OnPrem\",\n"
                                                + "  \"type\": \"ON_PREM\",\n"
                                                + "  \"org_id\": \"5e5ff1c8-34b9-4fa3-9924-83eb14354d4c\",\n"
                                                + "  \"vcenter\": {\n"
    ...
    static final String POST_ONPREM_BODY_EMPTY_NAMESERVER = "{\n"
                                                + "  \"name\": \"OnPrem\",\n"
                                                + "  \"type\": \"ON_PREM\",\n"
                                                + "  \"org_id\": \"5e5ff1c8-34b9-4fa3-9924-83eb14354d4c\",\n"
                                                + "  \"vcenter\": {\n"
