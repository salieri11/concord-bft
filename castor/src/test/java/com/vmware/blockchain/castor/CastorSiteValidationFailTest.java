...
/**
 * Test Site validation RPC round-trip, failure case.
 */
// Needs Junit4 for rules
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = CastorTestConfiguration.class)
public class CastorSiteValidationFailTest {
    ...
    public void init() throws IOException {
        ...
        // Failure case skeleton
        siteValidationServiceTest = new SiteValidationServiceTestImpl(false, completableFuture);
    ...
    @Test
    public void testSiteValidationCallFailure() throws IOException {
        ...
        Optional<String> bid = lines.stream()
                .filter(l -> l.contains("Site validation failed for zone: test-zone-1 - A, error: UNKNOWN"))
                .findFirst();
