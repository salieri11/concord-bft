                  ...
                  script {
                    ...
                    if (genericTests) {
                      sh '''
                        ...
                        mkdir "${test_log_root}"
                        echo "${PASSWORD}" | sudo -S "${python}" main.py SampleDappTests --dockerComposeFile ../docker/docker-compose.yml --resultsDir "${asset_transfer_test_logs}" --runConcordConfigurationGeneration
