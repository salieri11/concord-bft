                  ...
                  script {
                    ...
                    if (env.JOB_NAME.contains(on_demand_concord_deployment_job_name)) {
                      ...
                      sh '''
                        ...
                        echo "${PASSWORD}" | sudo -SE "${python}" main.py PersephoneTestsNew --dockerComposeFile ../docker/docker-compose-persephone.yml --tests="-m on_demand_concord_default" --resultsDir "${concord_deployment_test_logs}" --keepBlockchains ${deployment_retention} > "${concord_deployment_test_logs}/concord_deployment_test.log" 2>&1
                      '''
                      jenkinsbuilderlib.ownWorkspace()
