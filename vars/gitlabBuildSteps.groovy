                  ...
                  script {
                    ...
                    if (genericTests) {
                      sh '''
                        ...
                        # RV, July 12, 2019: Supply chain dapp build fails.  Filed https://jira.eng.vmware.com/browse/VB-1214
                        ...
                        cd suites ; echo "${PASSWORD}" | sudo -SE ./memory_leak_test.sh --testSuite CoreVMTests --repeatSuiteRun 2 --tests='-k vmArithmeticTest/add0.json' --resultsDir "${mem_leak_test_logs}" ; cd ..
