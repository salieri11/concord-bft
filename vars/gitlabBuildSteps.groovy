                  ...
                  script {
                    ...
                    if (genericTests) {
                      ...
                      if (env.run_persephone_tests.toBoolean()) {
                        sh '''
                          # Enable this after fixing test issue trying to fetch undeploy docker image
                          echo "DISABLING - Running persephone testsuite as either this is a Master run or there is a code change in blockchain/persephone (or) blockchain/hermes"
