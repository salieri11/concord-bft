...
# source: package_management_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='package_management_service.proto',
...
ListKnownPackagesRequest = _reflection.GeneratedProtocolMessageType('ListKnownPackagesRequest', (_message.Message,), dict(
  ...
  __module__ = 'package_management_service_pb2'
