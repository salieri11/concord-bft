...
def start_stop_container(ip, container_name, start_wait_time=30, stop_wait_time=60):
    '''
    Function to start and stop container
    Args:
       ip: Node IP on which container has to be started/stopped
    ...
    if "running" in status:
        ...
        cmd_to_start_primary = "docker start " + container_name
