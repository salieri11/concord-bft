...
class PatchedConflictDetection(override val damlMetrics: Metrics)
    extends ConflictDetection(damlMetrics) {
  ...
  /**
    ...
    */
  override def detectConflictsAndRecover(
  ...
  private def produceRejectionOrDropSubmission(
    ...
    logEntry.getPayloadCase match {
      ...
      case PARTY_ALLOCATION_ENTRY | PACKAGE_UPLOAD_ENTRY | CONFIGURATION_ENTRY |
          ...
          PACKAGE_UPLOAD_REJECTION_ENTRY | PARTY_ALLOCATION_REJECTION_ENTRY | OUT_OF_TIME_BOUNDS_ENTRY=>
