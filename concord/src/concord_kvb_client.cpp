...
com::vmware::concord::KVBClientPool::KVBClientPool(std::vector<KVBClient*> &clients)
   : logger_(log4cplus::Logger::getInstance("com.vmware.concord.KVBClientPool")),
...
bool com::vmware::concord::KVBClientPool::send_request_sync(ConcordRequest &req,
                                                           bool isReadOnly,
                                                           ConcordResponse &resp)
{
   while (true) {
