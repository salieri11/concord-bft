...
import com.vmware.blockchain.protobuf.kotlinx.serialization.ProtoBuf.Varint.decodeSignedVarintInt
import com.vmware.blockchain.protobuf.kotlinx.serialization.ProtoBuf.Varint.decodeSignedVarintLong
import com.vmware.blockchain.protobuf.kotlinx.serialization.ProtoBuf.Varint.decodeVarint
import com.vmware.blockchain.protobuf.kotlinx.serialization.ProtoBuf.Varint.encodeVarint
import kotlinx.io.*
...
/**
 * Forked implementation of kotlinx.serialization's official Protocol Buffer serialization engine to
 * provide byte array encoding/decoding support.
 *
 * Note: The official implementation is pending an issue resolution regarding support of encoding /
 * decoding of byte array.
 *
 * Reference: https://github.com/Kotlin/kotlinx.serialization/issues/52
 */
class ProtoBuf(context: SerialModule = EmptyModule) : AbstractSerialFormat(context), BinaryFormat {
    ...
    open inner class ProtobufReader(val decoder: ProtobufDecoder) : TaggedDecoder<ProtoDesc>() {
        ...
        fun decodeTaggedBytes(): ByteArray = decoder.nextObject()
...
// Sourced from kotlinx.serialization.
...
// Sourced from kotlinx.serialization.
private fun InputStream.readToByteBuffer(bytes: Int): ByteBuffer {
