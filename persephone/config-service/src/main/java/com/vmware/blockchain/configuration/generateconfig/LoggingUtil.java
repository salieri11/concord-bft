...
public class LoggingUtil {
    ...
    /**
     * Generates the logging config environment variable file.
     * This would hold as spaceholder for any logging, metrics and tracing
     * g
     * related configuration files. The method signature is subject to change.
